      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <View style={styles.header}>
          <View style={[styles.headerIcon, { backgroundColor: color + '22' }]}>
            <Ionicons name={PERIOD_ICONS[activePeriod] as IoniconsName} size={22} color={color} />
          </View>
          <View style={{ flex: 1 }}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}
          ...
          {PERIODS.map(p => {
            ...
            return (
              ...
              >
                <Ionicons name={PERIOD_ICONS[p] as IoniconsName} size={13} color={active ? '#0E0E10' : MUTED} style={{ marginRight: 5 }} />
        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.listContent}
          ...
          {tasks.length === 0 ? (
            <View style={styles.emptyState}>
              <Ionicons name={PERIOD_ICONS[activePeriod] as IoniconsName} size={52} color={BORDER} />
